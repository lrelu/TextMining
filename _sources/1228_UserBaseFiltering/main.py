...
user_rating = [[4,0,5,0,1], [0,3,3,0,1], [3,0,4,2,1], [3,5,5,2,2], [0,0,2,0,0], [0,4,0,3,0], [1,2,1,0,3],[3,4,4,1,1],[2,0,1,3,3]]
...
def get_rating_prediction(user, item):
	...
	return (user_rating[neighborList[0][0]][item] + user_rating[neighborList[1][0]][item] + user_rating[neighborList[2][0]][item]) / 3.00
